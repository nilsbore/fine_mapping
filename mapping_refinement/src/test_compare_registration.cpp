...
float register_clouds_icp(Eigen::Matrix3f& R, Eigen::Vector3f& t,
...
int main(int argc, char** argv)
{
    ...
    std::vector<float> measurement_correct;
    ...
    good_info.bottomRightCorner<3, 3>() *= 1.0;//100.0;
