...
int main(int arg, char** argv)
{
    ...
    scan s2("/home/nbore/.ros/mapping_refinement/shot000003.pcd", "/home/nbore/.ros/mapping_refinement/transform000003.txt");
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud1(new pcl::PointCloud<pcl::PointXYZRGB>);
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud2(new pcl::PointCloud<pcl::PointXYZRGB>);
    pcl::io::loadPCDFile<pcl::PointXYZRGB>("/home/nbore/.ros/mapping_refinement/shot000001.pcd", *cloud1);
    pcl::io::loadPCDFile<pcl::PointXYZRGB>("/home/nbore/.ros/mapping_refinement/shot000003.pcd", *cloud2);
